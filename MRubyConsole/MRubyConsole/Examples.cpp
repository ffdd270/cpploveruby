...
void load_file_and_insert_class()
{
	...
	RClass* class_cextension = mrb_define_module(state, "CExtension");
	mrb_define_class_method(state, class_cextension, "c_method", mrb_c_method, MRB_ARGS_NONE());

	auto test_inst = mrb_class_new_instance(state, 0, nullptr, mrb_class_get(state, "Test"));
	mrb_funcall_argv(state, test_inst, mrb_intern_cstr(state, "call_c_function"), 0, nullptr);
